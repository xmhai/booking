...
// Configuration
///////////////////
var triggerHour="13"; // booking window hour (to change when test)
var activity="270"; // table tennis
var venues = [
	{"venue":"1053", "courts":["03", "01", "04"],"name":"seng kang table tennis"}
];

// to change the value of below setting and reload in extension manager to take effect
var venue="1053"; //bendermeer primary school
var startHour = 17; // 15:00
var duration = 2;
...
function bookCourtByNoAndSlot(courtNo, timeslot) {
	...
	$('[name="timeslots[]"]').each(function() {
		...
		if (timeslotVal.indexOf("Table "+courtNo)!=-1 && timeslotVal.indexOf(timeslot)!=-1) {
